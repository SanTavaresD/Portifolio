...
## 💡 Objetivo
Treinar habilidades de storytelling e análise de dados para três áreas distintas, sendo elas suporte, comercial e financeira.
...
- `suporte.png: Imagem do Dash de suporte
- `vendas.png: Imagem do Dash de vendas
